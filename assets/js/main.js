(function () {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    form.addEventListener("submit", function (e) {
      ...
      // Formatting the message to include the user's email in a more structured way
      const formattedMessage = `Message from: ${name}, Email: ${email}\n\n${message}`;
    ...
    function showMessage(text, isError) {
      ...
      responseMessage.className = `response-message ${isError ? "error" : ""}`;
  ...
  function toggleScrolled() {
    ...
    if (
      ...
      selectHeader.style.backgroundColor = "rgba(77, 44, 169, 0.9)";
    }
